...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    ballet_special2_.LoadFromAMC(Platform::FindFile("60_11.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special2_.TrimFront(140);
    ballet_special2_.TrimBack(100);
    ballet_special2_.CalcRelativeTranslations();

    ballet_special3_.LoadFromAMC(Platform::FindFile("05_12.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special3_.TrimFront(200);
    ...
    ballet_special4_.TrimFront(350);
    ballet_special4_.TrimBack(100);
    ballet_special4_.CalcRelativeTranslations();

    ballet_special5_.LoadFromAMC(Platform::FindFile("05_09.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special5_.TrimFront(189);
    ballet_special5_.TrimBack(98);
